...
/*Apaga todos relacionados ao funcionario 10*/
...
/* Apaga a tabela "dependentes" */
drop table dependentes;

/* Apaga a tabela "funcionarios" */
drop table funcionarios;

/* Apaga o banco de dados "um_para_muitos" */
drop database um_para_muitos;
